...
if __name__== "__main__":
	...
	parser.add_argument('-errorT2', dest='errorT2', help='Optional, default:0.5; Error threshold for none 200s in status code', default=0.5)
	parser.add_argument('-errorTB', dest='errorTB', help='Optional, default:0.5; Error threshold for unknown status in status code', default=0.5)
